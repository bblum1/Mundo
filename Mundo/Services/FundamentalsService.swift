        ...
        let task = URLSession.shared.dataTask(with: request as URLRequest) {
            ...
            do {
                ...
                if let parseJSON = returnJSON as? Dictionary<String, Any> {
                    ...
                    newDict["volume"] = parseJSON["volume"]
                    newDict["average_volume"] = parseJSON["average_volume"]
                    newDict["pe_ratio"] = parseJSON["pe_ratio"]
                    newDict["dividend_yield"] = parseJSON["dividend_yield"]
